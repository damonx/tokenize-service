...
public final class AccountMasker {
   ...
   *
   * <ul>
   *   <li>Null-safe and blank-safe input handling
   *   <li>Removes common separators (hyphens, spaces)
   *   <li>Shows only last 4 digits for privacy
   *   <li>Input validation with custom error messages
   *   <li>Efficient string manipulation
   * </ul>
   *
